    ...
    return (
        <div className="bg-stone-50 dark:bg-stone-950 min-h-screen py-16 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
            <div className="max-w-4xl mx-auto bg-white dark:bg-stone-900 p-8 md:p-12 rounded-2xl shadow-sm border border-stone-200 dark:border-stone-800 transition-colors">
                <h1 className="text-3xl md:text-4xl font-serif text-emerald-900 dark:text-emerald-400 mb-8 border-b border-stone-100 dark:border-stone-800 pb-6 transition-colors">
                ...
                <div className="space-y-8 text-stone-700 dark:text-stone-300">
                    <section>
                        <h2 className="text-xl font-bold text-stone-800 dark:text-stone-100 mb-4 tracking-tight">1. Responsable del Tratamiento</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-stone-800 dark:text-stone-100 mb-4 tracking-tight">2. Finalidad de la Recolección de Datos</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-stone-800 dark:text-stone-100 mb-4 tracking-tight">3. Derechos del Titular de los Datos</h2>
                        <p className="mb-3 text-sm leading-relaxed">
                        ...
                        <p className="mt-4 text-sm bg-emerald-50 dark:bg-emerald-900/10 p-4 rounded-lg border border-emerald-100 dark:border-emerald-800/30">
                            Para ejercer cualquiera de estos derechos, puede enviar una solicitud escrita al correo electrónico <a href="mailto:info@laherreria.co" className="text-emerald-700 dark:text-emerald-400 font-medium hover:underline">info@laherreria.co</a>. Su solicitud será atendida en un plazo máximo de 10 días hábiles.
                        </p>
                    </section>

                    <section>
                        <h2 className="text-xl font-bold text-stone-800 dark:text-stone-100 mb-4 tracking-tight">4. Uso de Cookies y Tecnologías de Rastreo</h2>
                        <p className="mb-3 text-sm leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-stone-800 dark:text-stone-100 mb-4 tracking-tight">5. Seguridad de la Información</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-stone-800 dark:text-stone-100 mb-4 tracking-tight">6. Transferencia Internacional de Datos</h2>
                        <p className="text-sm leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-stone-800 dark:text-stone-100 mb-4 tracking-tight">7. Cambios en la Política</h2>
                        <p className="text-sm leading-relaxed">
                    ...
                    <div className="pt-8 border-t border-stone-200 dark:border-stone-800 text-sm text-stone-500 dark:text-stone-500">
