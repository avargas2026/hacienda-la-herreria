        ...
        <div className="py-20 px-4 bg-stone-50 min-h-screen">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="bg-white p-8 rounded-2xl shadow-sm border border-stone-100 h-full">
                    ...
                    <div className="bg-emerald-50 p-8 rounded-2xl border border-emerald-100 h-full">
